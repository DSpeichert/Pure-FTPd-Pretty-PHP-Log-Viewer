<?php
        ...
        $ftpAccountsPath = '/srv/vhosts/default/html/';
        $refreshRate = 60; // Refreshes the page every Nth seconds
        ...
        function cleanRow($text){
                ...
                $file = str_replace($ftpAccountsPath.$account, '', $file);
                $file = explode('/', $file);
                $file[0] = null;
                $file = implode('/', $file);
                        ...
                        <table>
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                                ...
                                                <td><?php echo human_filesize($data['filesize']); ?></td>
